...
{
    const string ConnectionString = @"Server=LOCALHOST;Database=SqlDependencyListenerTest;User Id=sa;Password=User1234;Encrypt=False;TrustServerCertificate=True";
    const string Database = "SqlDependencyListenerTest";
    const string Schema = "dbo";
    const string Table = "TEST_TABLE";
    const string QueueName = "TEST_NOTIFICATIONS_QUEUE";
    private const string QueueSchemaName = "dbo";
    ...
    static void AutomatedSqlDependencyListener()
    {
        var options = new SqlDependencyListenerOptions
        {
            ...
            // QueueSchemaName = QueueSchemaName, // Optional (default "dbo")
            // QueueName = QueueName,
